В приложенном архиве лежат 2 файла: setup.exe и TVCOMStringInstaller.msi. Для корректной работы приложения необходимо включить setup.exe, если у вас не установлен .NET Framework на компьютере, 
